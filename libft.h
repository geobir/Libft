...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2013/11/19 11:44:24 by kcouliba          #+#    #+#             */
/*   Updated: 2013/12/27 22:20:31 by kcouliba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lstpushfirst(t_list **alst, t_list *new);
t_list	*ft_lstgetlast(t_list *list);
int		ft_lstsorted(t_list *list);
int		ft_lstrsorted(t_list *list);
